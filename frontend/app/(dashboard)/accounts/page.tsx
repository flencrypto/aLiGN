...
export default function AccountsPage() {
  ...
  const [newAccount, setNewAccount] = useState<NewAccountForm>({ name: '', type: 'Client', location: '', website: '', logo_url: '', notes: '' });
  ...
  async function handleCreateAccount(e: React.FormEvent) {
    ...
    try {
      ...
      setNewAccount({ name: '', type: 'Client', location: '', website: '', logo_url: '', notes: '' });
    } finally {
      setSaving(false);
    }
  }
        ...
        {selected && (
          <div className="w-80 xl:w-96 border-l border-slate-700 bg-slate-800 overflow-auto p-5 flex-shrink-0">
            ...
            <div className="space-y-2 text-sm mb-5">
              ...
              {selected.tier_target && <p className="text-slate-400">Tier: <span className="text-slate-200">{selected.tier_target}</span></p>}
